...
const $$ProfileUser = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$ProfileUser;
  const adminProfile = {
    joinedAt: "12 de Octubre de 2023",
    profileImage: "https://avatars.githubusercontent.com/u/114163660?v=4",
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Perfil de usuario" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex justify-center m-6 my-20"> <div class="w-full max-w-4xl"> <!-- Sección superior del perfil (foto y detalles) --> <div class="flex items-center"> <img${addAttribute(adminProfile.profileImage, "src")} alt="Foto de perfil" class="w-44 h-44 rounded-full border-2 border-gray-300"> <div class="ml-6"> <h1 class="text-4xl font-bold">${userData.name}</h1> <p class="text-gray-500">${userData.email}</p> <p class="text-blue-500 font-semibold">${userData.role}</p> <p class="text-sm text-gray-400">Miembro desde ${adminProfile.joinedAt}</p> </div> </div> <!-- Barra de navegación de acciones --> <div class="flex mt-8 space-x-4 border-b border-gray-300 pb-2"> <button class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-2 px-4 rounded">
Gestionar Usuarios
...
}, "C:/Users/Keria/Documents/segundaOportunidad/public/public/src/pages/routes/profileUser.astro", void 0);

const $$file = "C:/Users/Keria/Documents/segundaOportunidad/public/public/src/pages/routes/profileUser.astro";
const $$url = "/routes/profileUser";
